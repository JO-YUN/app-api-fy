	...
	$.ajax({
		...
		success: function(result) {
			if(result.errorcode == 1) {
				...
				$('#segmentedControlContents').append('<div class="miit-f"><div class="miit">ICP备案编号：<a  target="_blank" href="http://www.beian.miit.gov.cn/">黑ICP备18002311号-2</a ><div> 码上城市（黑龙江）数字科技有限公司 版权所有</div></div></div>');
