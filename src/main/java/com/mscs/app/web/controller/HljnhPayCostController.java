...
/**
* @title: HljnhPayCostController 
* @description：测试
* @author： 刘威巍
* @date： 2019年1月18日 上午8:58:25
 */
@Controller
@RequestMapping("hljnh")
public class HljnhPayCostController extends BIZController {
	public static final Logger logger = LoggerFactory.getLogger(HljnhPayCostController.class);
	@Autowired
