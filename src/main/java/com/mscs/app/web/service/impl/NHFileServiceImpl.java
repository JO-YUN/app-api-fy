...
import com.mscs.app.web.dao.NHFileMapper;
import com.mscs.app.web.service.NHFileService;


@Service
public class NHFileServiceImpl implements NHFileService{
	public static Logger logger = LoggerFactory.getLogger(NHFileServiceImpl.class);
	@Autowired
	private NHFileMapper fileMapper;
